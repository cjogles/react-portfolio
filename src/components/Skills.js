...
const rows = [
  createData('HTML/CSS', 'Preprocessing w/ Less, Styling w/ Flexbox, Mobile Responsive Design, SEO mindful'),
  ...
  createData('FrontEnd Style', 'Material UI --> Used it to build this portfolio in addition to vanilla CSS'),
