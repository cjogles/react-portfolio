...
const data = [
 ...
 ["Back End", "I know how to use NodeJS to create a server and back end API using Express, Knex, Sqlite3, PostgresQL, and SQL. I know how to implement middleware to provide an authentication layer on the Server API. I am continually learning to handle more copmlex database queries."],
